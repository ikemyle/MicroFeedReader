namespace MicroFeedReader.Feeds
{
    ...
    public class Rss091Feed : BaseFeed
    {
        ...
        public override Feed ToFeed()
        {
            Feed f = new(this)
            {
                Copyright = this.Copyright ?? string.Empty,
                Description = this.Description ?? string.Empty,
                ImageUrl = this.Image?.Url ?? string.Empty,
                Language = this.Language ?? string.Empty,
                LastUpdatedDate = this.LastBuildDate,
                LastUpdatedDateString = this.LastBuildDateString ?? string.Empty,
